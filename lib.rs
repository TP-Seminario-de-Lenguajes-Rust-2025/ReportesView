...
mod tests {
    ...
    fn generar_vec_usuarios() -> Vec<Usuario> {
        ...
        let c = Usuario::new(account_id(AccountKeyring::Charlie), String::from("Charlie"), String::from("charlie@email.com"));
        usuarios.push(a);
        usuarios.push(b);
        usuarios.push(c);
        usuarios
    ...
    fn test_get_cantidad_ordenes_por_usuario_exitosa(){
        ...
        assert_eq!(ordenes_por_usuario[0].nombre_usuario, reporte_ordenes_usuario[0].nombre_usuario);
        assert_eq!(ordenes_por_usuario[0].cantidad_ordenes, reporte_ordenes_usuario[0].cantidad_ordenes);
        
        assert_eq!(ordenes_por_usuario[1].nombre_usuario, reporte_ordenes_usuario[1].nombre_usuario);
        assert_eq!(ordenes_por_usuario[1].cantidad_ordenes, reporte_ordenes_usuario[1].cantidad_ordenes);
    }
